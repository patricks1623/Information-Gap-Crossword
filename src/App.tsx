          ...
          <div key={`${r}-${c}`} className="relative w-full aspect-square">
            ...
            {cell.isFilledForRole ? (
              <div className={cn(
                ...
                isSolvedByPartner ? "bg-slate-200 dark:bg-slate-700 ring-2 ring-emerald-500 dark:ring-emerald-400 border-transparent text-slate-800 dark:text-slate-200 z-10" : "bg-slate-200 dark:bg-slate-700 border-slate-300 dark:border-slate-600 text-slate-800 dark:text-slate-200"
              )}>
                {cell.letter}
                {showPartnerTyping && (
          ...
          {myWords.map((pw: PlacedWord) => {
            ...
            return (
              <div key={pw.number} className={cn(
                ...
                isSolved ? "bg-emerald-50 dark:bg-emerald-900/20 border-transparent ring-2 ring-emerald-500 dark:ring-emerald-400 z-10" : "bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700"
              )}>
